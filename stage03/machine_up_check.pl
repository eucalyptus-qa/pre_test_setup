...
### Check if Non-NC Eucalyptus Components are Rebooted Cleanly
print "\n\n----------------------- Signal Check on NON-NC Eucalyptus Components -----------------------\n";
...
if( $is_error == 1 ){
	print "\n[TEST_REPORT]\tFAILED TO CONTACT SOME MACHINES !!!\n\n";
	exit(1);
};
...
if( $is_checked == 1 ){
	...
	print "\n[TEST_REPORT]\tALL MACHINES ARE UP AND RUNNING\n\n";
}else{
